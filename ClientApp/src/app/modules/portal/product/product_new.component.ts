...
@Component({
    selector     : 'portal_product_new',
    templateUrl: './product_new.component.html',
  styleUrls: ['./product_new.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class portal_product_newComponent  implements OnInit
{
    /**
     * Constructor
     */
...
private _fuseMediaWatcherService: FuseMediaWatcherService,
   ...
   ngOnInit() {
    ...
    gotoTypeNewsPage(id_type_news): void {
        ...
        const url = '/portal _product_new/' + id_type_news;
