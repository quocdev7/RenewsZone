...
import { portal_person_event_popUpAddComponent } from './popupAdd.component';
// import { portal_person_event_popUpFileDinhKemComponent } from './popupFileDinhKem.component';
// import { portal_person_event_popUpAnhDinhKemSuKienComponent } from './popupAnhDinhKemSuKien.component';
...
@Component({
    selector: 'portal_person_event_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class portal_person_event_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'sys_person_event',
    ...
    //}
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(portal_person_event_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    //     model.actionEnum = 2;
    //     const dialogRef = this.dialog.open(portal_person_event_popUpAnhDinhKemSuKienComponent, {
    //         disableClose: true,
    ...
    //     model.actionEnum = 2;
    //     const dialogRef = this.dialog.open(portal_person_event_popUpFileDinhKemComponent, {
    //         disableClose: true,
