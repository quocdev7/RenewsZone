...
@Component({
    selector: 'portal_person_event_popUpAnhDinhKemSuKien',
    templateUrl: 'popupAnhDinhKemSuKien.component.html',
    styleUrls: ['./popupAnhDinhKemSuKien.component.scss']
})
export class portal_person_event_popUpAnhDinhKemSuKienComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<portal_person_event_popUpAnhDinhKemSuKienComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'person_event', dialogRef, dialogModal);
        this.record = data;
    ...
    public reload(): void {
        this.http
            .post('/person_event.ctr/get_list_image/', {
