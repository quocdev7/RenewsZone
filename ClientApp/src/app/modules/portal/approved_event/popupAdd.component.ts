...
@Component({
    selector: 'portal_approved_event_popUpAdd',
    templateUrl: 'popupAdd.html',
    styleUrls: ['./popupAdd.component.scss']
})
export class portal_approved_event_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<portal_approved_event_popUpAddComponent>,
