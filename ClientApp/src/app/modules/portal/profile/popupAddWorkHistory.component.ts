...
@Component({
    selector: 'popupAddWorkHistory',
    templateUrl: 'popupAddWorkHistory.component.html',
})
export class popupAddWorkHistoryComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<popupAddWorkHistoryComponent>,
    ...
    saveWorkHistory() {
        this.http
            .post(this.controller + '.ctr/createWorkHistory/',
                {
                    data: this.record,
                }
            ).subscribe(resp => {
