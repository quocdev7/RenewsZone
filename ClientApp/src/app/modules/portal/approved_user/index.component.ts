...
import { portal_approval_user_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'portal_approval_user_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class portal_approved_user_indexComponent extends BaseIndexDatatableComponent {
    public file: any;
