...
@Component({
    selector: 'portal_approval_user_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class portal_approval_user_popUpAddComponent extends BasePopUpAddComponent {
    listsex: any;
    listdepartment: any;
    listjob_title: any;
    listtype: any;
    ...
    constructor(public dialogRef: MatDialogRef<portal_approval_user_popUpAddComponent>,
