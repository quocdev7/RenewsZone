...
@Component({
    selector: 'sys_event_popupFileDinhKem',
    templateUrl: 'popupFileDinhKem.component.html',
    styleUrls: ['./popupFileDinhKem.component.scss']
})
export class sys_event_popupFileDinhKemComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_event_popupFileDinhKemComponent>,
    ...
    saveFileDinhKemEvent(): void {
        ...
        if (this.list_file.length == 0) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.http
                        .post('sys_event.ctr/create_listfile/',
                            {
    ...
    submitFile() {
        ...
        modelsubmit.list_file = this.list_file;
        formData.append('model', JSON.stringify(modelsubmit));
        this.aftersavefail();
        this.http.post('sys_event.ctr/upload_file', formData, {
            reportProgress: true,
            observe: 'events'
        })
            .subscribe(res => {
    ...
    remove_file(id): void {
        ...
        Swal.fire({
            ...
            if (result.value) {
                this.http
                    .post('sys_event.ctr/delete_file/',
                        {
