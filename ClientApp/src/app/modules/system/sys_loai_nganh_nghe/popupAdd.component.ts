...
@Component({
    selector: 'sys_loai_nganh_nghe_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_loai_nganh_nghe_popUpAddComponent extends BasePopUpAddComponent {
    public file_image: any;
    public Progress_image: any = -1;
    public lst_nhom: any;
    constructor(public dialogRef: MatDialogRef<sys_loai_nganh_nghe_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_loai_nganh_nghe', dialogRef, dialogModal);
        this.record = data;
