...
@Component({
    selector: 'sys_event_program_popupLanguage',
    templateUrl: 'popupLanguage.component.html',
})
export class sys_event_program_popUpLanguageComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_event_program_popUpLanguageComponent>,
