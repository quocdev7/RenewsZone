...
@Component({
    selector: 'sys_event_program_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_event_program_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_event_program_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_event_program', dialogRef, dialogModal);
        this.record = data;
        ...
        if (this.actionEnum != 1) {
            ...
            this.http
                .post('/sys_event_program.ctr/getListItem/', {
        ...
        this.timyconfig = {
            ...
            file_picker_callback: function (cb, value, meta) {
                ...
                var controller = "sys_event_program";
                var type = "editor";
    ...
    load_dien_gia() {
        ...
        this.http
            .post('/sys_dien_gia.ctr/getListUseNew/', {
                id:this.record.db.event_id
            }
            ).subscribe(resp => {
                this.list_dien_gia = resp;
                this.list_dien_gia.splice(0, 0, {
                    id: "",
                    name: this._translocoService.translate('system.chon')
                })
            });
