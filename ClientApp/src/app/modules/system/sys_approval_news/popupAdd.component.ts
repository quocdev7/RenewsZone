...
@Component({
    selector: 'sys_approval_news_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_approval_news_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_approval_news_popUpAddComponent>,
