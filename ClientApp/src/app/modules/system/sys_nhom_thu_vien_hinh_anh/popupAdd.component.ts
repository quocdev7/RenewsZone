...
@Component({
    selector: 'sys_nhom_thu_vien_hinh_anh_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_nhom_thu_vien_hinh_anh_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_nhom_thu_vien_hinh_anh_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_nhom_thu_vien_hinh_anh', dialogRef, dialogModal);
        this.record = data;
