...
@Component({
    selector: 'sys_dien_gia_popupAdd',
    templateUrl: 'popupAdd.html',
    styleUrls: ['./popupAdd.component.scss']
})
export class sys_dien_gia_popUpAddComponent extends BasePopUpAddComponent {
    public file_image: any;
    public Progress_image: any = -1;
    public group_field: any;
    constructor(public dialogRef: MatDialogRef<sys_dien_gia_popUpAddComponent>,
