...
@Component({
    selector: 'sys_thu_vien_hinh_anh_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_thu_vien_hinh_anh_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_thu_vien_hinh_anh_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,  private imageCompress: NgxImageCompressService,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_thu_vien_hinh_anh', dialogRef, dialogModal);
        this.record = data;
