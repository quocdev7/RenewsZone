...
@Component({
    selector: 'sys_event_nha_tai_tro_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_event_nha_tai_tro_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_event_nha_tai_tro_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_event_nha_tai_tro', dialogRef, dialogModal);
        this.record = data;
        console.log(data);
