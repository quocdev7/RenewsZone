...
@Component({
    selector: 'sys_nhom_hoi_dong_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_nhom_hoi_dong_popUpAddComponent extends BasePopUpAddComponent {
    public plugintiny = [
    ...
    constructor(public dialogRef: MatDialogRef<sys_nhom_hoi_dong_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_nhom_hoi_dong', dialogRef, dialogModal);
        this.record = data;
        ...
        this.timyconfig = {
            ...
            file_picker_callback: function (cb, value, meta) {
                ...
                var controller = "sys_nhom_hoi_dong";
                var type = "editor";
