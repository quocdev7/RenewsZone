...
@Component({
    selector: 'sys_nhom_nganh_nghe_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_linh_vuc_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_linh_vuc_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_linh_vuc', dialogRef, dialogModal);
        this.record = data;
