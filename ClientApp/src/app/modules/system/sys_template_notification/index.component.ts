...
import { sys_template_notification_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_template_notification_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_template_notification_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog,'sys_template_notification',
    ...
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_template_notification_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
