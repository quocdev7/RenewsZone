...
@Component({
    selector: 'sys_nghi_quyet_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_nghi_quyet_popUpAddComponent extends BasePopUpAddComponent {
    public plugintiny = [
    ...
    constructor(public dialogRef: MatDialogRef<sys_nghi_quyet_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,private imageCompress: NgxImageCompressService,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_nghi_quyet', dialogRef, dialogModal);
        this.record = data;
