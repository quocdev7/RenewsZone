...
@Component({
    selector: 'sys_video_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_video_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_video_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_video', dialogRef, dialogModal);
        this.record = data;
            ...
            this.http.post('FileManager/uploadimagenew', formData, {
                ...
                .subscribe(res => {
                    ...
                    if (res.type == HttpEventType.UploadProgress) {
                        ...
                        item = res.body;
                        if (is_thumbnail) {
                            this.record.db.image_thumnail = item.location + "&v=" + uuidv4();
                        } else {
    ...
    //                 this.record.db.image_thumnail = item.location;
    //                 this.file_image = null
    //                 this.Progress_image = -1;
