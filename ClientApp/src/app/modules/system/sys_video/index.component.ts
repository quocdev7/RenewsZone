...
import { sys_video_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_video_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_video_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient,private titleService: Title, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'sys_video',
            { search: "", status_del: "1" }
        )
    ...
    //}
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_video_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
