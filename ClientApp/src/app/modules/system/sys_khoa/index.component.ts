...
import { sys_khoa_popUpAddComponent } from './popupAdd.component';
...
export class sys_khoa_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog,'sys_khoa',
            { search: "", status_del: "1" }
        )
    ...
    //}
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_khoa_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
