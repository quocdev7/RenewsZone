...
@Component({
    selector: 'sys_cot_moc_su_kien_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_cot_moc_su_kien_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_cot_moc_su_kien_popUpAddComponent>,
