...
@Component({
    selector: 'sys_cau_hinh_duyet_su_kien_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_cau_hinh_duyet_su_kien_popUpAddComponent extends BasePopUpAddComponent {
     public list_type_news: any = [];
     public list_khoa: any = [];
     
    public item_chose: any;

    constructor(public dialogRef: MatDialogRef<sys_cau_hinh_duyet_su_kien_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_cau_hinh_duyet_su_kien', dialogRef, dialogModal);
        this.record = data;
