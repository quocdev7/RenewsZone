...
@Component({
    selector: 'sys_khuyen_mai_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_khuyen_mai_popUpAddComponent extends BasePopUpAddComponent {
    public plugintiny = [
    ...
    constructor(public dialogRef: MatDialogRef<sys_khuyen_mai_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_khuyen_mai', dialogRef, dialogModal);
        this.record = data;
