...
import { sys_event_contact_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_event_contact_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_event_contact_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient,private titleService: Title, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'sys_event_contact',
    ...
    openDialogAdd(): void {
        if (this.filter.event_id === "" || this.filter.event_id === null) {
            ...
            const dialogRef = this.dialog.open(sys_event_contact_popUpAddComponent, {
                disableClose: true,
                width: '850px',
                data: {
                    actionEnum: 1,
    ...
    ngOnInit(): void {
        this.baseInitData();
        this.setDocTitle('Ban tổ chức - Liên hệ - Xelex'); 
    }
