...
@Component({
    selector: 'sys_type_news_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_type_news_popUpAddComponent extends BasePopUpAddComponent {
    public file_image: any;
    public Progress_image: any = -1;
    public group_news: any;
    constructor(public dialogRef: MatDialogRef<sys_type_news_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_type_news', dialogRef, dialogModal);
        this.record = data;
