...
@Component({
    selector: 'sys_event_khach_moi_popupAdd',
    templateUrl: 'popupAdd.html',
    styleUrls: ['./popupAdd.component.scss']
})
export class sys_event_khach_moi_popUpAddComponent extends BasePopUpAddComponent {
    public file_logo: any;
    public file_image: any;
    public Progress_logo: any = -1;
    public group_field: any;
    public Progress_image: any = -1;
    constructor(public dialogRef: MatDialogRef<sys_event_khach_moi_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,private imageCompress: NgxImageCompressService,
        public dialogModal: MatDialog,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_event_khach_moi', dialogRef, dialogModal);
        this.record = data;
