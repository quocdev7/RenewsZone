...
export class sys_nhom_nganh_nghe_popUpAddComponent extends BasePopUpAddComponent {
    public file_image: any;
    public Progress_image: any = -1;
    constructor(public dialogRef: MatDialogRef<sys_nhom_nganh_nghe_popUpAddComponent>,
        ...
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_nhom_nganh_nghe', dialogRef, dialogModal);
        this.record = data;
