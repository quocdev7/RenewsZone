...
export class sys_banner_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient,private titleService: Title, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'sys_banner',
            { search: "", status_del: "1" }
        )
    ...
    //}
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_banner_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
