...
@Component({
    selector: 'sys_anh_noi_bat_su_kien_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_anh_noi_bat_su_kien_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_anh_noi_bat_su_kien_popUpAddComponent>,
        http: HttpClient, _translocoService: TranslocoService,
        _fuseNavigationService: FuseNavigationService, route: ActivatedRoute,
        @Inject('BASE_URL') baseUrl: string,
        public dialogModal: MatDialog, private imageCompress: NgxImageCompressService,
        @Inject(MAT_DIALOG_DATA) data: any) {
        super(_translocoService, _fuseNavigationService, route, baseUrl, http, 'sys_anh_noi_bat_su_kien', dialogRef, dialogModal);
        this.record = data;
