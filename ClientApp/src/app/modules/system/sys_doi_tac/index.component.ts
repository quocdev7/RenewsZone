...
import { sys_doi_tac_popUpAddComponent } from './popupAdd.component';
...
import { sys_doi_tac_popUpLanguageComponent } from './popupLanguage.component';
import { Title } from '@angular/platform-browser';


@Component({
    selector: 'sys_doi_tac_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_doi_tac_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient,private titleService: Title, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog,'sys_doi_tac',
            { search: "", status_del: "1",id_loai_doi_tac:"-1" }
        )
    ...
    openDialogEditlanguage(model, pos): void {
        debugger
        this.http
        .post('/sys_doi_tac.ctr/load_ngon_ngu/', {
          ...
          model.actionEnum = 2;
          const dialogRef = this.dialog.open(sys_doi_tac_popUpLanguageComponent, {
              disableClose: true,
              width: '768px',
    ...
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_doi_tac_popUpAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit(): void {
        this.baseInitData();
        this.setDocTitle('Đối tác - Xelex'); 
    }
