...
@Component({
    selector: 'sys_doi_tac_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_doi_tac_popUpAddComponent extends BasePopUpAddComponent {
    ...
    constructor(public dialogRef: MatDialogRef<sys_doi_tac_popUpAddComponent>,
