...
{
    public partial class sys_nang_luc_hinh_anhController : BaseAuthenticationController
    {
        private sys_nang_luc_hinh_anh_repo repo;

        public sys_nang_luc_hinh_anhController(IUserService userService,worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_nang_luc_hinh_anh_repo(context);
        }


        public IActionResult getListUse([FromBody] JObject json)
        {
            var result = repo._context.sys_nang_luc_hinh_anh
        ...
        public IActionResult getListHinhAnh([FromBody] JObject json)
        {
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_nang_luc_hinh_anh_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                var query = repo.FindAll()
                     ...
                     .Where(d => d.db.create_by.Contains(search))
                     ;
          ...
          .ToList());
                DTResult<sys_nang_luc_hinh_anh_model> result = new DTResult<sys_nang_luc_hinh_anh_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
