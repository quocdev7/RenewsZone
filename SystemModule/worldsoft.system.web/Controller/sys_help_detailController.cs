...
namespace worldsoft.system.web.Controller
{
    public partial class sys_help_detailController : BaseAuthenticationController
    {
        ...
        public sys_help_detailController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                var query = repo.FindAll()
                      .Where(d => d.db.id_help == id_help)
                     .Where(d => d.db.title.Contains(search))
                     ;
