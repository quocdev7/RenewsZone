...
{
    public partial class sys_companyController : BaseAuthenticationController
    {
        public sys_company_repo repo;

        public sys_companyController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_company_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_companys
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_company_model>(json.GetValue("data").ToString());
        ...
        .ToList());
                DTResult<sys_company_model> result = new DTResult<sys_company_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
