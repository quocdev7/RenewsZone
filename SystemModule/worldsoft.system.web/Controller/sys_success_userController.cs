...
{
    public partial class sys_success_userController : BaseAuthenticationController
    {
        public sys_success_user_repo repo;

        public sys_success_userController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_success_user_repo(context);
        }
        ...
        {
            var result = repo._context.sys_success_users.
                 Select(d => new
                 {
                     id = d.id,
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                //   .ToList());
                DTResult<sys_success_user_model> result = new DTResult<sys_success_user_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    //data = dataList,
