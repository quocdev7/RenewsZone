...
{
    public partial class sys_event_nha_tai_troController : BaseAuthenticationController
    {
        public sys_event_nha_tai_tro_repo repo; 

        public sys_event_nha_tai_troController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_event_nha_tai_tro_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_event_nha_tai_tros
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_event_nha_tai_tro_model>(json.GetValue("data").ToString());
      ...
      .ToList());
                DTResult<sys_event_nha_tai_tro_model> result = new DTResult<sys_event_nha_tai_tro_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
