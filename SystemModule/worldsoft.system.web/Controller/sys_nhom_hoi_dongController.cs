...
{
    public partial class sys_nhom_hoi_dongController : BaseAuthenticationController
    {
        public sys_nhom_hoi_dong_repo repo; 

        public sys_nhom_hoi_dongController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_nhom_hoi_dong_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_nhom_hoi_dongs
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_nhom_hoi_dong_model>(json.GetValue("data").ToString());
      ...
      .ToList());
                DTResult<sys_nhom_hoi_dong_model> result = new DTResult<sys_nhom_hoi_dong_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
