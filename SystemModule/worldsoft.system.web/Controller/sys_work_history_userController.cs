...
{
    public partial class sys_work_history_userController : BaseAuthenticationController
    {
        public sys_work_history_user_repo repo;

        public sys_work_history_userController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_work_history_user_repo(context);
        }
        ...
        {
            var result = repo._context.sys_work_history_users.
                 Select(d => new
                 {
                     id = d.id,
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                //   .ToList());
                DTResult<sys_work_history_user_model> result = new DTResult<sys_work_history_user_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    //data = dataList,
