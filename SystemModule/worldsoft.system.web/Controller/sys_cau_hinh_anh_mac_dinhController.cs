...
namespace worldsoft.system.web.Controller
{
    public partial class sys_cau_hinh_anh_mac_dinhController : BaseAuthenticationController
    {
        ...
        public sys_cau_hinh_anh_mac_dinhController(IUserService userService,worldsoftDefautContext context) : base(userService)
        {
        ...
        public IActionResult getListUse()
        {
            ...
            var result = repo._context.sys_cau_hinh_anh_mac_dinhs
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                var query = repo.FindAll()
                       ...
                       .Where(d => d.db.type.Equals(type) || type == -1)
                     ;
