...
{
    public partial class sys_tien_teController : BaseAuthenticationController
    {
        public sys_tien_te_repo repo;

        public sys_tien_teController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_tien_te_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_tien_tes
        ...
        public IActionResult getListCompanyInfo()
        {
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_tien_te_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> getCompanyInfo([FromBody] JObject json)
        {
            var id = json.GetValue("id").ToString();
        ...
        .ToList());
                DTResult<sys_tien_te_model> result = new DTResult<sys_tien_te_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
