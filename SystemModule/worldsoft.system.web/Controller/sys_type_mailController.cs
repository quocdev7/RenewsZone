...
{
    public partial class sys_type_mailController : BaseAuthenticationController
    {
        public sys_type_mail_repo repo;

        public sys_type_mailController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
        ...
        {
            var result = repo._context.sys_type_mails
