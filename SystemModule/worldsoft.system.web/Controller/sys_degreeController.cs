...
{
    public partial class sys_degreeController : BaseAuthenticationController
    {
        public sys_degree_repo repo;

        public sys_degreeController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_degree_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_degrees
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_degree_model>(json.GetValue("data").ToString());
        ...
        .ToList());
                DTResult<sys_degree_model> result = new DTResult<sys_degree_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
