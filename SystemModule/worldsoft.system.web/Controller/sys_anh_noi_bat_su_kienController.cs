...
{
    public partial class sys_anh_noi_bat_su_kienController : BaseAuthenticationController
    {
        private sys_anh_noi_bat_su_kien_repo repo;

        public sys_anh_noi_bat_su_kienController(IUserService userService,worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_anh_noi_bat_su_kien_repo(context);
        }
        ...
        public IActionResult getListUse()
        {
            ...
            var result = repo._context.sys_anh_noi_bat_su_kiens
        ...
        public IActionResult getListHinhAnhNew([FromBody] JObject json)
        {
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_anh_noi_bat_su_kien_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
          ...
          .ToList());
                DTResult<sys_anh_noi_bat_su_kien_model> result = new DTResult<sys_anh_noi_bat_su_kien_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
