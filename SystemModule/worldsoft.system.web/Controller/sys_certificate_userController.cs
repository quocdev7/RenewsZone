...
{
    public partial class sys_certificate_userController : BaseAuthenticationController
    {
        public sys_certificate_user_repo repo;

        public sys_certificate_userController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_certificate_user_repo(context);
        }
        ...
        {
            var result = repo._context.sys_certificate_users.
                 Select(d => new
                 {
                     id = d.id,
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                //   .ToList());
                DTResult<sys_certificate_user_model> result = new DTResult<sys_certificate_user_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    //data = dataList,
