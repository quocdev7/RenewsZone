...
{
    public partial class person_eventController : BaseAuthenticationController
    {
        public person_event_repo repo;
        private IMailService _mailService;
        private IUserService _userService;
        public person_eventController(IUserService userService, IMailService mailService, worldsoftDefautContext context) : base(userService)
        {
            repo = new person_event_repo(context);
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<person_event_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<person_event_model> result = new DTResult<person_event_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
