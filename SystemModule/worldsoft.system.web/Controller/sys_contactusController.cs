...
{
    public partial class sys_contactusController : BaseAuthenticationController
    {
        private sys_contactus_repo repo;

        public sys_contactusController(IUserService userService,worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_contactus_repo(context);
        }
        
       
        public IActionResult getListUse()
        {
            var result = repo._context.sys_contactus
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_contactus_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
          ...
          .ToList());
                DTResult<sys_contactus_model> result = new DTResult<sys_contactus_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
