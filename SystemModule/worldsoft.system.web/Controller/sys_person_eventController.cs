...
{
    public partial class sys_person_eventController : BaseAuthenticationController
    {
        public sys_person_event_repo repo;
        private IMailService _mailService;
        private IUserService _userService;
        public sys_person_eventController(IUserService userService, IMailService mailService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_person_event_repo(context);
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_person_event_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<sys_person_event_model> result = new DTResult<sys_person_event_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
