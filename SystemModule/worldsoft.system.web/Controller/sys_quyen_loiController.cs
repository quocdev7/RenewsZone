...
{
    public partial class sys_quyen_loiController : BaseAuthenticationController
    {
        public sys_quyen_loi_repo repo; 

        public sys_quyen_loiController(IUserService userService, worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_quyen_loi_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_quyen_lois
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_quyen_loi_model>(json.GetValue("data").ToString());
      ...
      .ToList());
                DTResult<sys_quyen_loi_model> result = new DTResult<sys_quyen_loi_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
