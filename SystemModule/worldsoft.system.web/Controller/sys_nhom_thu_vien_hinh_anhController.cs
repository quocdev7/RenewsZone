...
{
    public partial class sys_nhom_thu_vien_hinh_anhController : BaseAuthenticationController
    {
        private sys_nhom_thu_vien_hinh_anh_repo repo;

        public sys_nhom_thu_vien_hinh_anhController(IUserService userService,worldsoftDefautContext context) : base(userService)
        {
            repo = new sys_nhom_thu_vien_hinh_anh_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_nhom_thu_vien_hinh_anhs
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_nhom_thu_vien_hinh_anh_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
          ...
          .ToList());
                DTResult<sys_nhom_thu_vien_hinh_anh_model> result = new DTResult<sys_nhom_thu_vien_hinh_anh_model>
                {
                    start = param.Start,
                    draw = param.Draw,
                    data = dataList,
