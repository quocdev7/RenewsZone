...
{
    public class sys_event_model
    {
        public sys_event_model()
        {
            db = new sys_event_db();
            ...
            khoa = new List<string>();
            hinhthuc = new List<string>();
        }
        ...
        public string luu_y_tham_gia_mobile_en { get; set; } 
        public string location_en { get; set; }
        public string dieu_kien_tham_gia_en { get; set; }
        public string ban_to_chuc_en { get; set; }
        public string luu_y_tham_gia_en { get; set; }
        public string ten_nhom_hoi_dong { get; set; }
    }
    public class sys_event_ref_model
    {
